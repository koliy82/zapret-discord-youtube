...
- [**`Steam.bat`**](./Steam.bat) / [**`Roblox.bat`**](./Roblox.bat) / [**`Tyr.bat`**](./Tyr.bat) - готовые конфиги для игр: обход блокировок конкретных игровых хостов (TLS-фейк для API/шлюзов и UDP-десинк для игровых серверов)
